    ...
    def tokenize(self, text):
        ...
        if self.dev:
            ...
            text = re.sub(
                ...
                r' \u060C \1',
                text)
            # separate out on Urdu characters followed by non-Urdu characters
            # and vice-versa
            text = re.sub(
                '([\u0617-\u061a\u0620-\u065f\u066e-\u06d3\u06d5'
                '\u06fa-\u06ff\ufe70-\ufeff\ufb50-\ufdff])'
